/* ========== SERVICE WORKER - GESTION CACHE OFFLINE ET PWA ==========
   ...
   📱 APPLICATION: quiz-general-premier (إختبار شامل1)
========== */
 ...
 */
const CACHE_NAME = 'quiz-general-premier-v27';
...
const urlsToCache = [
    ...
    '/quiz-general-premier/sw.js',
    '/quiz-general-premier/images/icon-192.png',
    '/quiz-general-premier/images/icon-512.png',
    '/quiz-general-premier/images/screenshot-1.png',
    '/quiz-general-premier/images/screenshot-2.png'
];
...
self.addEventListener('fetch', event => {
    ...
    event.respondWith(
        ...
        caches.match(request)
            .then(response => {
                if (response) {
                    console.log('✅ Réponse trouvée en cache:', request.url);
                    return response;
                }
                ...
                return fetch(request)
                    ...
                    .catch(() => {
                        ...
                        console.error('❌ Non en cache et réseau indisponible:', request.url);
